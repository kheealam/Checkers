...
namespace WindowsFormsApplication1
{
    class CheckerPiece
    {
        ...
        public static Image Image_Black = Image.FromFile(@"E:\SampleCheckersFinal\SampleCheckers\Resources\Pieces_Black2.png");
        public static Image Image_Red = Image.FromFile(@"E:\SampleCheckersFinal\SampleCheckers\Resources\Pieces_Red2.png");
        public static Image Image_King_Black = Image.FromFile(@"E:\SampleCheckersFinal\SampleCheckers\Resources\King_Black2.png");
        public static Image Image_King_Red = Image.FromFile(@"E:\SampleCheckersFinal\SampleCheckers\Resources\King_Red2.png");
        public static SoundPlayer king = new SoundPlayer(@"E:\SampleCheckersFinal\SampleCheckers\Resources\trumpet.wav");
        public static SoundPlayer moveS = new SoundPlayer(@"E:\SampleCheckersFinal\SampleCheckers\Resources\button-47.wav");
        public static SoundPlayer moveSC = new SoundPlayer(@"E:\SampleCheckersFinal\SampleCheckers\Resources\button-21.wav");
        ...
        public static void AISave(Button[] array)
        {
            ...
            else if (length != 0)
            {
                ...
                for (int c = 0; c < array.Length; c++)
                {
                   ...
                   else if ((array1[length].Location == new Point(array[c].Location.X + 80, array[c].Location.Y + 80) || array1[length].Location == new Point(array[c].Location.X + 80, array[c].Location.Y + 80)) && array[c].BackgroundImage == CheckerPiece.Image_Red)
                   { 
                      if (CheckerPiece.turn == false)
                      {
                          Move(ref array1[length], ref array[c]);
