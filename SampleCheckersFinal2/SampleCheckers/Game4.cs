...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (CheckerPiece.turn == true)
            {
                if (ForTimer == true)
                {
                    ...
                    if (globalButton.BackgroundImage == CheckerPiece.Image_Black)
                    {
            ...
            else if (CheckerPiece.turn == false)
            {
                if (ForTimer == true)
                {
                    ...
                    if (globalButton.BackgroundImage == CheckerPiece.Image_Red)
                    {
                        globalButton.FlatAppearance.BorderColor = Color.Red;
                    }
                    ForTimer = false;
        ...
        {
            CheckerPiece.CapBlackPieces = 0;
            CheckerPiece.CapRedPieces = 0;
