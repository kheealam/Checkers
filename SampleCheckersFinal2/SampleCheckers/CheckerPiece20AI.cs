...
namespace WindowsFormsApplication1
{
    class CheckerPiece
    {
        ...
        public static Image Image_Black = Image.FromFile(@"D:\SampleCheckersFinal2\SampleCheckers\Resources\Pieces_Black2.png");
        public static Image Image_Red = Image.FromFile(@"D:\SampleCheckersFinal2\SampleCheckers\Resources\Pieces_Red2.png");
        public static Image Image_King_Black = Image.FromFile(@"D:\SampleCheckersFinal2\SampleCheckers\Resources\King_Black2.png");
        public static Image Image_King_Red = Image.FromFile(@"D:\SampleCheckersFinal2\SampleCheckers\Resources\King_Red2.png");
        public static SoundPlayer king = new SoundPlayer(@"D:\SampleCheckersFinal2\SampleCheckers\Resources\trumpet.wav");
        public static SoundPlayer moveS = new SoundPlayer(@"D:\SampleCheckersFinal2\SampleCheckers\Resources\button-47.wav");
        public static SoundPlayer moveSC = new SoundPlayer(@"D:\SampleCheckersFinal2\SampleCheckers\Resources\button-21.wav");
                ...
                for (int i = 0; i < array.Length; i++)
                {
                    if (array[i].BackgroundImage == Image_Red || array[i].BackgroundImage == Image_King_Red)
                    {
                        for (int a = 0; a < array.Length; a++)
                        {
                            ...
                            if (array[i].BackgroundImage == CheckerPiece.Image_King_Red)
                            {
                                if (array[i].Location == new Point(array[a].Location.X + 80, array[a].Location.Y + 80) && array[a].BackgroundImage == null)
                                {
                                    if (norm < length)
                    ...
                    if ((array1[length].Location == new Point(array[a].Location.X - 80, array[a].Location.Y - 80) || array1[length].Location == new Point(array[a].Location.X + 80, array[a].Location.Y - 80)) && array[a].BackgroundImage == null)
                    {
                        if (array[a].Location.Y == 610)
                        {
                            if (CheckerPiece.turn == false)
                            {
                                ...
                                array[a].BackgroundImage = CheckerPiece.Image_King_Red;
                                turn = true;
                                break;
                            }
                        }
        ...
        public static void AISave(Button[] array)
        {
            ...
            else if (length != 0)
            {
                ...
                for (int c = 0; c < array.Length; c++)
                {
                   if ((array1[length].Location == new Point(array[c].Location.X - 80, array[c].Location.Y + 80) || array1[length].Location == new Point(array[c].Location.X + 80, array[c].Location.Y + 80)) && array[c].BackgroundImage == CheckerPiece.Image_Red)
                   {
                      if (CheckerPiece.turn == false)
                      {
                   ...
                   else if ((array1[length].Location == new Point(array[c].Location.X - 80, array[c].Location.Y - 80) || array1[length].Location == new Point(array[c].Location.X + 80, array[c].Location.Y - 80)) && array[c].BackgroundImage == CheckerPiece.Image_King_Red)
                   {
                        if (CheckerPiece.turn == false)
                        {
                            Move(ref array1[length], ref array[c]);
