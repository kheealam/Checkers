            ...
            else if (isEmptySelf == true)
            {
                ...
                else if (SCLick == true)
                {
                    if (gloBut.Location == new Point(locx + 80, locy + 80) || gloBut.Location == new Point(locx - 80, locy + 80))
                    {
                        ...
                        else if (gloBut.BackgroundImage == CheckerPiece.Image_King_Red || gloBut.BackgroundImage == CheckerPiece.Image_Black || gloBut.BackgroundImage == CheckerPiece.Image_King_Black)
                        {
                            CheckerPiece.Move(ref gloBut, ref locBut);
                        }
                    }
                    else if (gloBut.Location == new Point(locBut.Location.X - 80, locBut.Location.Y - 80) || gloBut.Location == new Point(locBut.Location.X + 80, locBut.Location.Y - 80))
                    {
                        ...
                        else if (gloBut.BackgroundImage == CheckerPiece.Image_King_Black || gloBut.BackgroundImage == CheckerPiece.Image_Red || gloBut.BackgroundImage == CheckerPiece.Image_King_Red)
                        {
                            CheckerPiece.Move(ref gloBut, ref locBut);
                        }
                    }
