    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (isEmptySelf == false && isOur == false)
            {
                ...
                {
                    //Check the location of the next Box.                   
                    if (gloBut.Location == new Point(locx - 80, locy + 80))
                    {
                        for (int i = 1; i <= myArray.Length; i++)
                        {
                            ...
                            //{
                            if (myArray[i].Location == new Point(locx + 80, locy - 80) || myArray[i].Location == new Point(locx - 80, locy - 80) && piece1.IsEmpty(myArray[i]) == true)
                            {
            ...
            else if (isEmptySelf == true)
            {
                ...
                else if (SCLick == true)
                {
                    ...
                    else if (gloBut.Location == new Point(locBut.Location.X - 80, locBut.Location.Y - 80))
                    {
                        //if king
                    }
                }
